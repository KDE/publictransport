...
#ifndef TIMETABLEACCESSOR_VVS_HEADER
#define TIMETABLEACCESSOR_VVS_HEADER

#include "timetableaccessor_efa.h"

class TimetableAccessorVvs : public TimetableAccessorEfa
{
    public:
...
#endif // TIMETABLEACCESSOR_VVS_HEADER
