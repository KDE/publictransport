...
function getTimetable( values ) {
    var url = "http://www2.vvs.de/vvs/XSLT_DM_REQUEST" +
	"?language=de&useRealtime=1&type_dm=stop&mode=direct" +
	"&place_dm=" + values.city +
	"&name_dm=" + values.stop +
	"&deleteAssignedStops=1&dmLineSelectionAll=1" +
	"&ppLineSelectionAll=0&dmLineSelection=all";
