...
QString Helper::trim( const QString& str ) const
{
    QString s = str;
    return s.trimmed().replace( QRegExp( "^(&nbsp;)+|(&nbsp;)+$", Qt::CaseInsensitive ), "" ).trimmed();
}

QString Helper::stripTags( const QString& str ) const
{
    QRegExp rx( "<\\/?[^>]+>" );
    rx.setMinimal( true );
...
QString Helper::camelCase( const QString& str ) const
{
...
QVariantList Helper::matchTime( const QString& str, const QString& format ) const
{
...
QVariantList Helper::matchDate( const QString& str, const QString& format ) const
{
...
QString Helper::formatTime( int hour, int minute, const QString& format ) const
{
    return QTime( hour, minute ).toString( format );
}

QString Helper::formatDate( int year, int month, int day, const QString& format ) const
{
    return QDate( year, month, day ).toString( format );
}

int Helper::duration( const QString& sTime1, const QString& sTime2, const QString& format ) const
{
...
QString Helper::addMinsToTime( const QString& sTime, int minsToAdd, const QString& format ) const
{
...
QString Helper::addDaysToDate( const QString& sDate, int daysToAdd, const QString& format ) const
{
...
QVariantList Helper::addDaysToDateArray( const QVariantList& values, int daysToAdd ) const
{
    if ( values.count() != 3 ) {
...
QStringList Helper::splitSkipEmptyParts( const QString& str, const QString& sep ) const
{
