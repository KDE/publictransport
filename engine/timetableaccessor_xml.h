...
public:
    ...
    /** @brief Gets the type of the accessor, ie. XmlAccessor. */
...
protected:
    /**
     * @brief Parses the contents of a document that was requested using requestDepartures()
     ...
     * @return false, if there were an error parsing the document.
     **/
    virtual bool parseDocumentForStopSuggestions( const QByteArray &document, QList<StopInfo*> *stops );
