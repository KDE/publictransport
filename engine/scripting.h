...
public Q_SLOTS:
     ...
     **/
    QString stripTags( const QString &str ) const;
     ...
     **/
    QString camelCase( const QString &str ) const;
    ...
    QString extractBlock( const QString &str,
                          const QString &beginString, const QString &endString ) const;
     ...
     * @see formatTime
     **/
    QVariantList matchTime( const QString &str, const QString &format = "hh:mm" ) const;
     ...
     * @see formatDate TODO
     **/
    QVariantList matchDate( const QString &str, const QString &format = "yyyy-MM-dd" ) const;
     ...
     * @see matchTime
     **/
    QString formatTime( int hour, int minute, const QString &format = "hh:mm" ) const;
     ...
     * @see matchTime
     **/
    QString formatDate( int year, int month, int day, const QString &format = "yyyy-MM-dd" ) const;
    ...
    int duration( const QString &sTime1, const QString &sTime2,
                  const QString &format = "hh:mm" ) const;
    ...
    QString addDaysToDate( const QString &sDate, int daysToAdd,
                           const QString &format = "yyyy-MM-dd" ) const;

    QVariantList addDaysToDateArray( const QVariantList &values, int daysToAdd ) const;
     ...
     **/
    QStringList splitSkipEmptyParts( const QString &str, const QString &sep ) const;
...
public Q_SLOTS:
    ...
    bool contains( TimetableInformation info ) const { return m_values.contains(info); };
