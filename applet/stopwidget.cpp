...
StopWidget::StopWidget( const StopSettings& stopSettings, const QStringList& filterConfigurations,
		...
		m_stopSettings(stopSettings), m_filterConfigurations(filterConfigurations),
		m_stop(0), m_provider(0), m_modelLocations(modelLocations),
...
StopListWidget::StopListWidget( const StopSettingsList& stopSettingsList,
		...
		m_filterConfigurations(filterConfigurations), m_modelLocations(modelLocations),
		m_modelServiceProviders(modelServiceProviders),
