...
public:
    ...
    /** @brief Format for values of keywords. */
    QTextCharFormat &formatValue() { return m_formatValue; };

    /**
     * @brief Format for syntax errors, eg. a keyword which is already in the string but only
     *   allowed once.
     *
...
/**
 * @brief A KLineEdit with syntax highlighting.
 *
...
protected slots:
    /** @brief Sets the new text to the QTextDocument and highlights it. */
...
protected:
    ...
    /** @brief Reimplemented to set the cursor to the correct position in the QTextDocument. */
    virtual void mousePressEvent( QMouseEvent *ev );

    /** @brief Reimplemented to select the correct characters in the QTextDocument. */
    virtual void mouseMoveEvent( QMouseEvent *ev );

    /** @brief Reimplemented to paint the highlighted QTextDocument. */
    virtual void paintEvent( QPaintEvent *ev );

    /** @brief Does effectively almost the same as QLineEditPrivate::moveCursor(). */
    void moveCursor( int pos, bool mark );

    /** @brief Gets the QRect in which the QTextDocument is drawn. */
