...
//     friend class PublicTransport;
	...
	int serviceProvider() const { return m_serviceProvider; };
	...
	// Wheather or not a type of vehicle should be shown
	void hideTypeOfVehicle(VehicleType vehicleType) { m_showTypeOfVehicle[vehicleType] = false; }; // TODO: save
